...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-03-2025 a las 18:27:55
...
--
ALTER TABLE `detallefavoritos`
  MODIFY `iddetfav` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `favoritos`
  MODIFY `idfav` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `pagina`
  MODIFY `idpag` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
ALTER TABLE `pagxperfil`
  MODIFY `idperpf` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
