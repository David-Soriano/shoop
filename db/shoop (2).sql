...
INSERT INTO `detallecarrito` (`iddetcar`, `idcar`, `idpro`, `cantidad`) VALUES
(1, 1, 57, 1);
...
(151, 'proinf/imagen_674f53f351d12.webp', 'samsung', 'image/webp', 57, 1, NULL);
...
(16, 'David', 'Soriano', 101564, 'admin@gmail.com', '3186274255', 'M', NULL, 'CC', NULL, NULL, '2024-11-27 21:20:01', '2024-12-03 16:53:03', NULL, 2, '$2y$10$aGcbgN7SK.mxZRsTEfI3jeOcW7sueH9H4d.vRli3ouesWF6NG.SS6'),
(19, 'Kevin', 'Galindo', 1069302546, 'kevin@gmail.com', '3124855148', 'M', NULL, 'CC', NULL, NULL, '2024-12-03 18:05:44', '2024-12-03 18:05:44', NULL, 1, '$2y$10$t5cP9amsNh24ypzs6efIEOpalENYHZ42Y5Vhk1WaU9VweD97U8Z8e');
...
--
ALTER TABLE `carrito`
  MODIFY `idcar` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `detallecarrito`
  MODIFY `iddetcar` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `imagen`
  MODIFY `idimag` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;
...
--
ALTER TABLE `pagina`
  MODIFY `idpag` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `pagxperfil`
  MODIFY `idperpf` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `producto`
  MODIFY `idpro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT de la tabla `prodxprov`
--
ALTER TABLE `prodxprov`
  MODIFY `idprodprv` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT de la tabla `proveedor`
--
ALTER TABLE `proveedor`
  MODIFY `idprov` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
...
--
ALTER TABLE `usuario`
  MODIFY `idusu` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
